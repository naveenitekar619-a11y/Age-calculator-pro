    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-10">
      ...
      <div className="bg-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-xl space-y-8">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2.5 text-blue-400 font-bold text-lg">
            <span className="w-7 h-7 rounded-lg bg-blue-500/20 text-blue-300 flex items-center justify-center text-xs">
              1
            </span>
            <h2 className="text-slate-100">Year Calculation Method</h2>
          </div>
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed pl-9">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2.5 text-blue-400 font-bold text-lg">
            ...
            <h2 className="text-slate-100">Month Calculation Method</h2>
          </div>
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed pl-9">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2.5 text-blue-400 font-bold text-lg">
            ...
            <h2 className="text-slate-100">Day Calculation Method</h2>
          </div>
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed pl-9">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2.5 text-blue-400 font-bold text-lg">
            ...
            <h2 className="text-slate-100">Leap Years &amp; February 29 Birthdays</h2>
          </div>
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed pl-9">
          ...
          <ul className="list-disc pl-14 text-sm text-slate-300 space-y-1">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2.5 text-blue-400 font-bold text-lg">
            ...
            <h2 className="text-slate-100">Next Birthday Calculation</h2>
          </div>
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed pl-9">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2.5 text-blue-400 font-bold text-lg">
            ...
            <h2 className="text-slate-100">Total Days &amp; Approximate Time Units</h2>
          </div>
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed pl-9">
      ...
      <div className="text-center pt-4">
        <button
          ...
          className="inline-flex items-center gap-2 px-6 py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl shadow-md transition-colors"
        >
